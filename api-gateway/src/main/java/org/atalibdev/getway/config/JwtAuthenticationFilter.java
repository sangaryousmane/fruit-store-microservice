...
import org.atalibdev.getway.exception.JwtTokenMalformedException;
import org.atalibdev.getway.exception.JwtTokenMissingException;
...
public class JwtAuthenticationFilter implements GatewayFilter {
    ...
    public Mono<Void> filter(ServerWebExchange exchange, GatewayFilterChain chain) {
        ...
        if (isApiSecured.test(request)) {
            ...
            } catch (IllegalArgumentException | JwtTokenMalformedException |
                     SignatureException | UnsupportedJwtException | java.security.SignatureException e) {
                ServerHttpResponse response = exchange.getResponse();
